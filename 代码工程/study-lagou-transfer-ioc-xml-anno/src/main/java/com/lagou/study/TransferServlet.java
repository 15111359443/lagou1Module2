...
import com.lagou.study.factory.ProxyFactory;
import com.lagou.study.pojo.Result;
import com.lagou.study.service.TransferService;
import com.lagou.study.utils.JsonUtils;
...
public class TransferServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        // 通过 SpringIOC 提供的工具类获取 WebApplicationContext，在通过 WebApplicationContext 获取对应的对象
        WebApplicationContext webApplicationContext = WebApplicationContextUtils.getWebApplicationContext(this.getServletContext());

        // 通过 applicationContext.xml 配置的信息，获取相对应的文件
